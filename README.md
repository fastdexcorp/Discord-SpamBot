...
- Discord Developer Portal
  ...
  - 6- Copy your bot token from developer applications, start the python and paste the token.
  - 7- Once you've done all this and added the app to your Discord account, simply go to a random channel on Discord server you want and run /spamcustom `THE_TEXT_YOU_WANT` or /sendembed
